...
As the result above shows the R2 of the model is $\approx 0.33$%, which is not good. Also in the plot the relationship between the predictors and the response is not linear.
